"""CreatePluginInstanceOrganizationPluginsInstancesPost tool implementation."""
import json
import logging
...
@mcp.tool()
def createplugininstanceorganizationpluginsinstancespost(
    organization: str,
    plugin: dict,
    project: dict,
    ...
    request_body["plugin"] = plugin
    request_body["project"] = project
    
    # Build URL
    url = f"{config['base_url']}/{organization}/plugins/instances"
