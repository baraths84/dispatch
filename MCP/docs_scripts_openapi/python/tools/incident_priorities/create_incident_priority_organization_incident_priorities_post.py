"""CreateIncidentPriorityOrganizationIncidentPrioritiesPost tool implementation."""
import json
import logging
...
@mcp.tool()
def createincidentpriorityorganizationincidentprioritiespost(
    organization: str,
    name: str,
    color: str = None,
    default: bool = None,
    ...
    # Build URL
    url = f"{config['base_url']}/{organization}/incident_priorities"
