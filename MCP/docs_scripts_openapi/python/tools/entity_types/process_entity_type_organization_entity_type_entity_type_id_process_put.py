"""ProcessEntityTypeOrganizationEntityTypeEntityTypeIdProcessPut tool implementation."""
import json
import logging
...
@mcp.tool()
def processentitytypeorganizationentitytypeentitytypeidprocessput(
    entity_type_id: int,
    organization: str,
    ...
    # Build URL
    url = f"{config['base_url']}/{organization}/entity_type/{entity_type_id}/process"
