"""CreateEntityTypeOrganizationEntityTypePost tool implementation."""
import json
import logging
...
@mcp.tool()
def createentitytypeorganizationentitytypepost(
    organization: str,
    project: dict,
    ...
    # Build URL
    url = f"{config['base_url']}/{organization}/entity_type"
