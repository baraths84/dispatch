"""CreateIncidentCostTypeOrganizationIncidentCostTypesPost tool implementation."""
import json
import logging
...
@mcp.tool()
def createincidentcosttypeorganizationincidentcosttypespost(
    organization: str,
    name: str,
    project: dict,
    category: str = None,
    ...
    # Build URL
    url = f"{config['base_url']}/{organization}/incident_cost_types"
