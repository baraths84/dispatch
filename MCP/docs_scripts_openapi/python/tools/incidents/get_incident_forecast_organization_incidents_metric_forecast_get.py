"""GetIncidentForecastOrganizationIncidentsMetricForecastGet tool implementation."""
import json
import logging
...
@mcp.tool()
def getincidentforecastorganizationincidentsmetricforecastget(
    organization: str,
    page: int = None,
    ...
    # Build URL
    url = f"{config['base_url']}/{organization}/incidents/metric/forecast"
