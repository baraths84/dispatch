"""JoinIncidentOrganizationIncidentsIncidentIdJoinPost tool implementation."""
import json
import logging
...
@mcp.tool()
def joinincidentorganizationincidentsincidentidjoinpost(
    organization: str,
    incident_id: int
) -> str:
    """
    ...
    # Build URL
    url = f"{config['base_url']}/{organization}/incidents/{incident_id}/join"
