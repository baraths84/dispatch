"""CreateTacticalReportOrganizationIncidentsIncidentIdReportTacticalPost tool implementation."""
import json
import logging
...
@mcp.tool()
def createtacticalreportorganizationincidentsincidentidreporttacticalpost(
    organization: str,
    incident_id: int,
    actions: str,
    conditions: str,
    ...
    request_body["needs"] = needs
    
    # Build URL
    url = f"{config['base_url']}/{organization}/incidents/{incident_id}/report/tactical"
