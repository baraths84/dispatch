"""CreateIncidentTypeOrganizationIncidentTypesPost tool implementation."""
import json
import logging
...
@mcp.tool()
def createincidenttypeorganizationincidenttypespost(
    organization: str,
    name: str,
    default: bool = None,
    ...
    # Build URL
    url = f"{config['base_url']}/{organization}/incident_types"
