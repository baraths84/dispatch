"""CreateSourceStatusOrganizationDataSourcesStatusesPost tool implementation."""
import json
import logging
...
@mcp.tool()
def createsourcestatusorganizationdatasourcesstatusespost(
    organization: str,
    project: dict,
    ...
    # Build URL
    url = f"{config['base_url']}/{organization}/data/sources/statuses"
