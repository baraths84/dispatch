"""GetSignalFiltersOrganizationSignalsFiltersGet tool implementation."""
import json
import logging
...
@mcp.tool()
def getsignalfiltersorganizationsignalsfiltersget(
    organization: str,
    page: int = None,
    ...
    # Build URL
    url = f"{config['base_url']}/{organization}/signals/filters"
