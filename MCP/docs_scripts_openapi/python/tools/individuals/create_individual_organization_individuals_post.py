"""CreateIndividualOrganizationIndividualsPost tool implementation."""
import json
import logging
...
@mcp.tool()
def createindividualorganizationindividualspost(
    organization: str,
    email: str,
    project: dict,
    company: str = None,
    ...
    # Build URL
    url = f"{config['base_url']}/{organization}/individuals"
