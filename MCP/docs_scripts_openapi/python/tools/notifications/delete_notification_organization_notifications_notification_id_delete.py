"""DeleteNotificationOrganizationNotificationsNotificationIdDelete tool implementation."""
import json
import logging
...
@mcp.tool()
def deletenotificationorganizationnotificationsnotificationiddelete(
    notification_id: int,
    organization: str
) -> str:
    """
