"""RegisterUserOrganizationAuthRegisterPost tool implementation."""
import json
import logging
...
@mcp.tool()
def registeruserorganizationauthregisterpost(
    organization: str,
    email: str,
    ...
    # Build URL
    url = f"{config['base_url']}/{organization}/auth/register"
