"""CreateDefinitionOrganizationDefinitionsPost tool implementation."""
import json
import logging
...
@mcp.tool()
def createdefinitionorganizationdefinitionspost(
    organization: str,
    project: dict,
    text: str,
    source: str = None,
    ...
    # Build URL
    url = f"{config['base_url']}/{organization}/definitions"
