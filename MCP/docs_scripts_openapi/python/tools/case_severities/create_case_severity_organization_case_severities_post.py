"""CreateCaseSeverityOrganizationCaseSeveritiesPost tool implementation."""
import json
import logging
...
@mcp.tool()
def createcaseseverityorganizationcaseseveritiespost(
    organization: str,
    name: str,
    color: str = None,
    default: bool = None,
    ...
    # Build URL
    url = f"{config['base_url']}/{organization}/case_severities"
